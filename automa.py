...
if __name__ == "__main__":
    ...
    try : # Try to get all the site id from a file
        ...
        if failed_sites == [] and sites_with_no_dns == []:
            print ('All Sites Updated Successfully')
        else:
            print ('the following sites failed to update:\t', failed_sites)
            print ('the following sites with no dns:\t', sites_with_no_dns)
        with open('failed_sites.txt', 'w') as f:
            for item in failed_sites:
                f.write("%s\n" % item)

        with open('sites_with_no_dns.txt', 'w') as f:
            for item in sites_with_no_dns:
                f.write("%s\n" % item)
